                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li>
                            <a
                                    ...
                                    href="controller?action=view-orders-for-managers&sort_field=${ sessionScope.sort_field }&sort_order=${ sessionScope.sort_order }&category_filter_id=${ sessionScope.category_filter_id }&order_status=-1&search_field=${ sessionScope.search_field }&offset=${ requestScope.offset }&records=8&cur_page=${ requestScope.cur_page}">
                        ...
                        <li>
                            <a
                                    class="dropdown-item ${ not empty sessionScope.category_filter_id && sessionScope.category_filter_id  == 0 ? 'text-danger' : '' }"
                                    href="controller?action=view-orders-for-managers&sort_field=${ sessionScope.sort_field }&sort_order=${ sessionScope.sort_order }&category_filter_id=${ sessionScope.category_filter_id }&order_status=0&search_field=${ sessionScope.search_field }&offset=${ requestScope.offset }&records=8&cur_page=${ requestScope.cur_page}">
                                canceled
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a
                                    class="dropdown-item ${ not empty sessionScope.category_filter_id && sessionScope.category_filter_id  == 0 ? 'text-danger' : '' }"
                                    href="controller?action=view-orders-for-managers&sort_field=${ sessionScope.sort_field }&sort_order=${ sessionScope.sort_order }&category_filter_id=${ sessionScope.category_filter_id }&order_status=2&search_field=${ sessionScope.search_field }&offset=${ requestScope.offset }&records=8&cur_page=${ requestScope.cur_page}">
                                preparing
                            </a>
                        </li>
                        <li>
                            <a
                                    class="dropdown-item ${ not empty sessionScope.category_filter_id && sessionScope.category_filter_id  == 0 ? 'text-danger' : '' }"
                                    href="controller?action=view-orders-for-managers&sort_field=${ sessionScope.sort_field }&sort_order=${ sessionScope.sort_order }&category_filter_id=${ sessionScope.category_filter_id }&order_status=3&search_field=${ sessionScope.search_field }&offset=${ requestScope.offset }&records=8&cur_page=${ requestScope.cur_page}">
                                delivering
                            </a>
                        </li>
                        <li>
                            <a
                                    class="dropdown-item ${ not empty sessionScope.category_filter_id && sessionScope.category_filter_id  == 0 ? 'text-danger' : '' }"
                                    href="controller?action=view-orders-for-managers&sort_field=${ sessionScope.sort_field }&sort_order=${ sessionScope.sort_order }&category_filter_id=${ sessionScope.category_filter_id }&order_status=4&search_field=${ sessionScope.search_field }&offset=${ requestScope.offset }&records=8&cur_page=${ requestScope.cur_page}">
                                delivered
                            </a>
                        </li>
                    </ul>
