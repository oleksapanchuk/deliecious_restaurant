...
//    static final Logger logger = LogManager.getLogger(ViewMenuAction.class);

    @Override
    public String execute(HttpServletRequest request, HttpServletResponse response) throws ServiceException {

        log.info("method execute of class ViewMenuAction executed");
        ...
        if (request.getParameter(PRODUCT_ID) != null && !request.getParameter(PRODUCT_ID).equals("none")) {
            ...
            if (isBuy != null && isBuy.equals("true")) return "controller?action=view-cart";
        }
